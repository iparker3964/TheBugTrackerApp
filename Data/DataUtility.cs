...
namespace TheBugTrackerApp.Data
{
    public static class DataUtility
    {
        ...
        {
            //The default connectionString will come from appSettings
            var connectionString = configuration.GetConnectionString("DefaultConnection");

            //It will be overwritten if running not in local environment
            var databaseUrl = Environment.GetEnvironmentVariable("DATABASE_URL");
            return string.IsNullOrEmpty(databaseUrl) ? connectionString : BuildConnectionString(databaseUrl);
        }
        public static string BuildConnectionString(string databaseUrl)
        {
            //provides on object representation of a uniform resource identifier (URI) and easy access to the parts of the URI.
        ...
        public static async Task ManageDataAsync(IHost host)
        {
            ...
            //Below injecting services into this datautility
        ...
        public static async Task SeedDefaultCompaniesAsync(ApplicationDbContext context)
        {
            try
            {
                ...
                await context.Companies.AddRangeAsync(defaultCompanies.Where(dc => !dbCompanies.Contains(dc.Name)));
                await context.SaveChangesAsync();

                //Get company id's
                company1Id = context.Companies.FirstOrDefault(c => c.Name.Equals("Company1")).Id;
                company2Id = context.Companies.FirstOrDefault(c => c.Name.Equals("Company2")).Id;
                company3Id = context.Companies.FirstOrDefault(c => c.Name.Equals("Company3")).Id;
                company4Id = context.Companies.FirstOrDefault(c => c.Name.Equals("Company4")).Id;
                company5Id = context.Companies.FirstOrDefault(c => c.Name.Equals("Company5")).Id;
        ...
        public static async Task SeedDefaultProjectPriorityAsync(ApplicationDbContext context)
        {
            try
            {
                ...
                var dbProjectPriorities = context.ProjectPriorities.Select(p => p.Name).ToList();

                await context.ProjectPriorities.AddRangeAsync(projectPriorities.Where(p => !dbProjectPriorities.Contains(p.Name)));
                await context.SaveChangesAsync();
            }
            catch (Exception ex)
            {
        ...
        {
            int priorityLowId = context.ProjectPriorities.FirstOrDefault(p => p.Name.Equals(BTTicketPriority.Low.ToString())).Id;
            int priorityMediumId = context.ProjectPriorities.FirstOrDefault(p => p.Name.Equals(BTTicketPriority.Medium.ToString())).Id;
            int priorityHighId = context.ProjectPriorities.FirstOrDefault(p => p.Name.Equals(BTTicketPriority.High.ToString())).Id;
            int priorityUrgent = context.ProjectPriorities.FirstOrDefault(p => p.Name.Equals(BTTicketPriority.Urgent.ToString())).Id;
            ...
            try
            {
                IList<Project> projects = new List<Project>()
                {
                    new Project()
                    {
                        ...
                        Description = "Single page html, css & javascript page. Serves as a landing page for candidates and contains a bio and link.",
                        StartDate = new DateTime(2021,8,20),
                        EndDate = new DateTime(2021,8,20).AddMonths(1),
                        ProjectPriorityId = priorityLowId
                    },
                    new Project()
                    {
                        CompanyId = company2Id,
                        Name = "Build a supplemental Blog Web Application",
                        Description = "Candidate's custom build web applicaition using .Net Core with MVC, a postgres database and hosted in a heroku enviornment.",
                        StartDate = new DateTime(2021,8,20),
                        EndDate = new DateTime(2021,8,20).AddMonths(4),
                        ProjectPriorityId = priorityMediumId
                    },
                    new Project()
                    {
                        CompanyId = company1Id,
                        Name = "Build an Issue Tracking Web Application",
                        Description = "A custom designed .Net Core application with postgres database. The application is a muli tennant application.",
                        StartDate = new DateTime(2021,8,20),
                        EndDate = new DateTime(2021,8,20).AddMonths(6),
                        ProjectPriorityId = priorityHighId
                    },
                    new Project()
                    {
                        CompanyId = company2Id,
                        Name = "Build an Address Book Web Application",
                        Description = "A custom designed .Net Core application with postgres database. This is an application to serve as a rolodex.",
                        StartDate = new DateTime(2021,8,20),
                    ...
                    new Project()
                    {
                        ...
                        Description = "A custom designed .Net core application with postgres database. An API based application.",
                        StartDate = new DateTime(2021,8,20),
        ...
        public static async Task SeedDefaultUsersAsync(UserManager<BTUser> userManager)
        {
            ...
            {
                UserName = "cparker@yahoo.com",
                Email = "cparker@yahoo.com",
                FirstName = "Chad",
                LastName = "Parker",
                EmailConfirmed = true,
                CompanyId = company2Id
            ...
            //Seed default project manager user
            defaultUser = new BTUser
            {
            ...
            {
                Console.WriteLine("***************** ERROR ***************");
                Console.WriteLine("Error seeding project manager 1 user");
                Console.WriteLine(ex.Message);
                Console.WriteLine("***************************************");
            ...
            {
                Console.WriteLine("**************** ERROR **************");
                Console.WriteLine("Error seeding project manager 2 user");
                Console.WriteLine(ex.Message);
                Console.WriteLine("*************************************");
            ...
            {
                Console.WriteLine("*********** ERROR ***************");
                Console.WriteLine("Error seeding developer 1 user");
                Console.WriteLine(ex.Message);
                Console.WriteLine("*********************************");
            ...
            defaultUser = new BTUser
            {
                ...
                Email = "Developer2@bugtrackeer.com",
                FirstName = "Cobe",
                LastName = "Parker",
                EmailConfirmed = true,
                CompanyId = company2Id
            ...
            {
                Console.WriteLine("*********** ERROR **************");
                Console.WriteLine("Error seeding developer 2 user");
                Console.WriteLine(ex.Message);
                Console.WriteLine("********************************");
            ...
            {
                Console.WriteLine("********** ERROR **************");
                Console.WriteLine("Error seeding developer 3 user");
                Console.WriteLine(ex.Message);
                Console.WriteLine("******************************");
            ...
            {
                Console.WriteLine("************* ERROR ***********");
                Console.WriteLine("Error seeding developer 4 user");
                Console.WriteLine(ex.Message);
                Console.WriteLine("*******************************");
            ...
            {
                Console.WriteLine("*********** ERROR ************");
                Console.WriteLine("Error seeding developer 5 user");
                Console.WriteLine(ex.Message);
                Console.WriteLine("******************************");
            ...
            {
                Console.WriteLine("************** ERROR *********");
                Console.WriteLine("Error seeding developer 6 user");
                Console.WriteLine(ex.Message);
                Console.WriteLine("******************************");
                throw;
            }
            ...
            {
                Console.WriteLine("************ ERROR ************");
                Console.WriteLine("Error seeding submitter 1 user");
                Console.WriteLine(ex.Message);
                Console.WriteLine("*******************************");
            ...
            {
                Console.WriteLine("*********** ERROR *************");
                Console.WriteLine("Error seeding submitter 2 user.");
                Console.WriteLine(ex.Message);
                Console.WriteLine("*******************************");
        ...
        public static async Task SeedDemoUsersAsync(UserManager<BTUser> userManager)
        {
            ...
            {
                Console.WriteLine("******************* ERROR *****************");
                Console.WriteLine("Error seeding demo project manager 1 user");
                Console.WriteLine(ex.Message);
                Console.WriteLine("*******************************************");
            ...
            {
                Console.WriteLine("**************** ERROR **************");
                Console.WriteLine("Error seeding demo developer 1 user");
                Console.WriteLine(ex.Message);
                Console.WriteLine("*************************************");
        ...
        public static async Task SeedDefaultTicketTypeAsync(ApplicationDbContext context)
        {
            try
            {
                ...
                var dbTicketTypes = context.TicketTypes.Select(t => t.Name).ToList();

                await context.TicketTypes.AddRangeAsync(ticketTypes.Where(t => !dbTicketTypes.Contains(t.Name)));
                await context.SaveChangesAsync();
            }
            catch (Exception ex)
            {
        ...
        public static async Task SeedDefaultTicketStatusAsync(ApplicationDbContext context)
        {
            try
            {
                IList<TicketStatus> ticketStatuses = new List<TicketStatus>()
                {
                    new TicketStatus()
                    {
                        Name = BTTicketStatus.New.ToString()
                    },
                    new TicketStatus()
                    {
                        Name = BTTicketStatus.Development.ToString()
                    },
                    new TicketStatus()
                    {
                        Name = BTTicketStatus.Testing.ToString()
                    },
                    new TicketStatus()
                    {
                ...
                var dbStatuses = context.TicketStatuses.Select(t => t.Name).ToList();

                await context.TicketStatuses.AddRangeAsync(ticketStatuses.Where(t => !dbStatuses.Contains(t.Name)));
                await context.SaveChangesAsync();
            }
            catch (Exception ex)
            {
        ...
        public static async Task SeedDefaultTicketPriorityAsync(ApplicationDbContext context)
        {
            try
            {
                ...
                var dbTicketPriorities = context.TicketPriorities.Select(t => t.Name).ToList();

                await context.AddRangeAsync(ticketPriorities.Where(t => !dbTicketPriorities.Contains(t.Name)));
                await context.SaveChangesAsync();
            }
            catch (Exception ex)
            {
        ...
        {
            //get project id's
            int portfolioId = context.Projects.FirstOrDefault(p => p.Name.Equals("Build a Personal Portfolio")).Id;
            int blogId = context.Projects.FirstOrDefault(p => p.Name.Equals("Build a supplemental Blog Web Application")).Id;
            int bugTrackerId = context.Projects.FirstOrDefault(p => p.Name.Equals("Build an Issue Tracking Web Application")).Id;
            int movieId = context.Projects.FirstOrDefault(p => p.Name.Equals("Build a Movie Information Web Application")).Id;

            //get ticket type id's
            int typeNewDev = context.TicketTypes.FirstOrDefault(t => t.Name.Equals(BTTicketType.NewDevelopment.ToString())).Id;
            int typeWorkTask = context.TicketTypes.FirstOrDefault(t => t.Name.Equals(BTTicketType.WorkTask.ToString())).Id;
            int typeDefect = context.TicketTypes.FirstOrDefault(t => t.Name.Equals(BTTicketType.Defect.ToString())).Id;
            int typeEnhancement = context.TicketTypes.FirstOrDefault(t => t.Name.Equals(BTTicketType.Enhancement.ToString())).Id;
            int typeChangeRequest = context.TicketTypes.FirstOrDefault(t => t.Name.Equals(BTTicketType.ChangeRequest.ToString())).Id;

            //get ticket priority id's
            int priorityLow = context.TicketPriorities.FirstOrDefault(t => t.Name.Equals(BTTicketPriority.Low.ToString())).Id;
            int priorityMedium = context.TicketPriorities.FirstOrDefault(t => t.Name.Equals(BTTicketPriority.Medium.ToString())).Id;
            int priorityHigh = context.TicketPriorities.FirstOrDefault(t => t.Name.Equals(BTTicketPriority.High.ToString())).Id;
            int priorityUrgent = context.TicketPriorities.FirstOrDefault(t => t.Name.Equals(BTTicketPriority.Urgent.ToString())).Id;

            //get ticket status id's
            int statusNew = context.TicketStatuses.FirstOrDefault(t => t.Name.Equals(BTTicketStatus.New.ToString())).Id;
            int statusDev = context.TicketStatuses.FirstOrDefault(t => t.Name.Equals(BTTicketStatus.Development.ToString())).Id;
            int statusTest = context.TicketStatuses.FirstOrDefault(t => t.Name.Equals(BTTicketStatus.Testing.ToString())).Id;
            int statusResolved = context.TicketStatuses.FirstOrDefault(t => t.Name.Equals(BTTicketStatus.Resolved.ToString())).Id;
            ...
            try
            {
                IList<Ticket> tickets = new List<Ticket>()
                {
                    ...
                    new Ticket(){Title = "Portfolio Ticket 8", Description = "Ticket details for protfolio ticket 8", Created = DateTimeOffset.Now, ProjectId = portfolioId, TicketPriorityId = priorityUrgent, TicketStatusId = statusTest, TicketTypeId = typeDefect},
                ...
                var dbTickets = context.Tickets.Select(t => t.Title).ToList();

                await context.Tickets.AddRangeAsync(tickets.Where(t => !dbTickets.Contains(t.Title)));
                await context.SaveChangesAsync();
            }
            catch (Exception ex)
            {
                Console.WriteLine("************* ERROR ************");
                Console.WriteLine("Error seeding default tickets");
                Console.WriteLine(ex.Message);
                Console.WriteLine("********************************");
